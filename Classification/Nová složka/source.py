...
def train(path = "train.csv"):
    ...
    n_greater_50k = data[data['income-class'] == '>50K'].shape[0]
    # Number of records where individual's income is at most $50,000
    n_at_most_50k = data[data['income-class'] == '<=50K'].shape[0]
    ...
    income_raw = data['income-class']
    features_raw = data.drop('income-class', axis = 1)
...
def train():
    global classifier
    classifier, acurracy = train("train.csv")
